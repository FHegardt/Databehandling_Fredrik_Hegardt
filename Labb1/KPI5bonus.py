...
# droppar dubletter så att Varje region bara finns med på ett ställe.
...
# Mergar på "Inner" på Vecka och Region för att få ut den datan jag behöver.
...
# Skapar själva plotten i plotly, som ett rörligt diagram.
